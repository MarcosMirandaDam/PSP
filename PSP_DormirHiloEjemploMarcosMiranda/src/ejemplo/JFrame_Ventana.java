...
/*
 * Cuando ejecutamos una aplicación de ventana basada en un formulario JFrame,
 * la máquina virtual de Java crea tres hilos por defecto:
 *
 * 1. el principal, donde corre el método Main() que inicia la aplicación 2.
 * el conocido como GC (recolector de basura), donde corre el código que se
 * encarga de optimizar los recursos de memoria 3. el conocido como EDT (hilo
 * despachador de eventos) de la AWT (paquete abstracto de herramientas de
 * ventana), donde corre el código encargado de atender las solicitudes de
 * dibujo del contenido de la ventana, y de atender a los eventos de ratón o
 * teclado provocados por el usuario (como la ejecución del código programado
 * para cuando el usuario hace click en un botón)
 *
 ...
 *
 * En esta aplicación queremos realizar una cuenta de 1 a 20, cuyo avance se
 * vaya reflejando en el JPanel que hemos colocado a modo de marcador. La cuenta
 * se pondrá en marcha cuando el usuario haga click en un botón.
 *
 ...
 *
 * El primer botón intenta hacerlo sin poner más hilos en juego. No lo
 * consigue. Y no lo consigue porque precisamente el hilo que recibe las
 * peticiones de pintado, es justo el que las está enviando a cada nuevo valor
 * de la cuenta. Y claro, se satura. Sólo cuando finaliza la cuenta (justo en
 * el 20), puede atender por fin a la solicitud de dibujo del marcador.
 *
 * Por el contrario el segundo y tercer botón delega en un hilo auxiliar, tanto
 * la cuenta como las peticiones de repintado del marcador. Además este hilo
 * auxiliar, en el caso del Botón 3 se duerme 1 décima de segundo por cuenta,
 * para que EDT tenga una buen ocasión de atender la petición de dibujo que le
 * acaba de enviar. El resultado es el esperado por fin
 */
public class JFrame_Ventana extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addGap(54, 54, 54)
...
//código que se ejecuta cuando el usuario hace click en el primer botón
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
		...
		Hilo miHilo = new Hilo(marcador, false);
...
//código que se ejecuta cuando el usuario hace click en el tercer botón
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
		...
		Hilo miHilo = new Hilo(marcador, true);
